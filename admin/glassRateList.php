...
if (isset($_GET['deleteSection'])){
    ...
    $sql="DELETE from glass_section_details WHERE id='$id'";
...
<div class="panel">
<div align="right">
<a  href="glassAddRateList.php" id="demo-dt-addrow-btn" class="btn btn-info btn-md" style="float: none;margin: 15px;font-size: 20px;height: 50px;width: 300px;font-family: serif;color: floralwhite;font-weight: bold;border-radius: 13px;border: 5px solid #047182e0;animation: 1.5s ease-in-out 0s 1 slideInFromRight;"><i class="pli-bishop icon-fw icon-lg"></i>
Add New Glass</a>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="panel-heading" style="animation: 1.5s ease 0s 1 slideInFromTop;">
                <h3 class="panel-title" style="font-family: serif;color: floralwhite;font-weight: bold;font-size:25px;">Glass Rate List</h3>
            ...
            <table class="table  table-bordered  table-hover" style="animation: 1.5s ease-in-out 0s 1 slideInFromLeft;">
                ...
                <thead>
                    <tr class="filters">
                     <th><input type="text" class="form-control" placeholder="#" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Glass Name" disabled></th>
                ...
                <?php
                    ...
                    $qr = "SELECT * FROM `glass_section_details` order by id desc";
                    ...
                    <tr>
                        ...
                        <td><a href="glassUpdateRateList.php?id=<?php echo $sectionID;?>" class="btn btn-info btn-xs" style="    border: 3px solid #384c5d45;
    border-radius: 9px;
    padding: 6px;
    font-size: 14px;
    font-family: unset;
...
<script>function deleteItem(b){swal({title:"Are you sure?",text:"You will not be able to recover this Glass!",type:"warning",showCancelButton:true,confirmButtonColor:"#ee4a47",confirmButtonText:"Yes, delete it!",closeOnConfirm:true},function(){window.location.href="glassRateList.php?deleteSection="+b})};</script>
